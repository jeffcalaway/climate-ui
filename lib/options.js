...
var fontStylesheet = document.createElement('style')
htmlTag.appendChild(fontStylesheet)

var fontSize = function(str){
  fontStylesheet.innerHTML = 'html, body {font-size: ' + str + '}'
}

fontSize(atom.config.get('climate-ui.cFontSize'));

atom.config.onDidChange('climate-ui.cFontSize', function(){
  fontSize(atom.config.get('climate-ui.cFontSize'))
})
